...
| Malformed release evidence | An unknown gate status or omitted browser result produces a ready verdict | One shared evaluator requires every named gate exactly once; unknown statuses, missing browser evidence, failed or skipped checks cannot pass |
