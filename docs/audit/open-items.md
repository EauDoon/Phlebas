...
| services-7 | Rate limiter is applied to public endpoints | services | needs middleware wiring |
| services-8 | Per-IP rate limit is enforced at the HTTP layer | services | depends on services-7 |
