...
test("landing and terminal banners stay simulation-only", async () => {
  ...
  assert.match(landingCss, /column-gap: 4px;/);
  assert.match(terminalCss, /column-gap: 4px;/);
  assert.match(landingCss, /row-gap: 4px;/);
  assert.match(terminalCss, /row-gap: 4px;/);
  assert.match(landingCss, /max-width: calc\(50% - 2px\)/);
  assert.match(terminalCss, /max-width: calc\(50% - 2px\)/);
  ...
  assert.match(landingCss, /z-index: auto;/);
  assert.match(terminalCss, /z-index: auto;/);
