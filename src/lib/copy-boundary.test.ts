...
test("landing and terminal banners stay simulation-only", async () => {
  ...
  assert.match(terminalCss, /flex: 1 0 calc\(50% - 4px\)/);
  ...
  assert.match(landingCss, /flex: 1 0 calc\(50% - 4px\)/);
  ...
  assert.match(landingCss, /max-width: calc\(50% - 4px\)/);
  assert.match(terminalCss, /max-width: calc\(50% - 4px\)/);
