...
* Immutable terms for price, amounts, fees, recipients, timing, observers, and chain-specific finality
* ZEC-first funding with causal chain-time checks and staggered refund deadlines
